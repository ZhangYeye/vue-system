<template>
  <div class="main">
    <div class="source-bill">
      <div class="select-area">
        <el-form label-position="left" :inline="true" @submit.native.prevent>
          <el-form-item class="field" label="退料单">
            <el-input
              class="text"
      ...
      <div class="detail-area">
        <el-form label-position="left" :inline="true">
          ...
          <el-form-item class="field" label="退料数量:">
            <span>100</span>
          </el-form-item>
        </el-form>
        <el-form label-position="left" :inline="true">
          ...
          <el-form-item class="field" label="物料编码:">
    ...
    <div class="return-accept-area">
      <el-tabs value="by-product">
        <el-tab-pane label="备品退料" name="by-product">
          <el-form :inline="true">
        ...
        <el-tab-pane label="物料退料" name="by-material">
          <el-form :inline="true">
    ...
    <div class="b-buttons">
      <el-button class="b-button" style="width: 120px;">从退料单导入</el-button>
