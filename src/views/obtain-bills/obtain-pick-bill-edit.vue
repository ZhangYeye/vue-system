<template>
  <div class="main">
    ...
    <div class="obtain-pick-area">
      <el-tabs value="by-product">
        <el-tab-pane label="备品拣料" name="by-product">
          <el-form :inline="true">
        ...
        <el-tab-pane label="物料拣料" name="by-material">
          <el-form :inline="true">
