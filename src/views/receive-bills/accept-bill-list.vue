  ...
  <div class="main">
    <div :class="{'fixed-header':true}" class="navList">
      ...
      <el-breadcrumb class="app-breadcrumb" separator=">">
        ...
        <el-breadcrumb-item>{{$t('acceptBill.acceptList')}}</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="list-container">
      ...
      <div class="data-list">
        <el-table :stripe="true" :data="arrivalList">
          ...
          <el-table-column prop="total" label="工单数量" width="100px" align="center"></el-table-column>
          <el-table-column prop="count" label="收货数量" width="100px" align="center"></el-table-column>
          <el-table-column prop="oper" label="操作" width="140px" align="center">
            <template slot-scope="scope">
              <router-link to="accept-bill-info">
